...
! function () {
		...
		if (n.execute)
			if (n.setters) s = S(n.execute);
				...
				if (!n.executingRequire)
					for (f = 0; f < n.dependencies.length; f++) g(n.dependencies[f]);
				s = j(n.execute, g, p.default, d), d.exports !== p.__useDefault && (p.default = p.__useDefault = d.exports);
				var h = p.default;
				if (h && h.__esModule)
					for (var m in h) Object.hasOwnProperty.call(h, m) && (p[m] = h[m])
	...
	function Be(e, t, r) {
		var n = e.depCache[r];
		if (n)
			for (a = 0; a < n.length; a++) t.normalize(n[a], r).then(K);
		else {
			var o = !1;
				...
				case "cjs":
					...
					e.registerDynamic(c, !0, function (o, i, a) {
						if (o.resolve = function (t) {
							...
							}, a.paths = [], a.require = o, !n.load.cjsDeferDepsExecute && l)
	...
	var nt, ot = "undefined" != typeof window && "undefined" != typeof document,
	...
	var Lt, At, It = /(?:^\uFEFF?|[^$_a-zA-Z\xA0-\uFFFF."'])require\s*\(\s*("[^"\\]*(?:\\.[^"\\]*)*"|'[^'\\]*(?:\\.[^'\\]*)*'|`[^`\\]*(?:\\.[^`\\]*)*`)\s*\)/g,
	...
	var Zt, Xt = function (e) {
		...
		function r(r, n, o) {
			...
			var a, s, u; - 1 !== (a = n.indexOf("require")) && (n.splice(a, 1), r || (n = n.concat(Ue(o.toString(), a)))), -1 !== (s = n.indexOf("exports")) && n.splice(s, 1), -1 !== (u = n.indexOf("module")) && n.splice(u, 1), r ? (e.registerDynamic(r, n, !1, i), Qt ? (Qt = void 0, lr = !0) : lr || (Qt = [n, i])) : e.registerDynamic(n, !1, cr ? qe(i) : i)
		}
	...
	var dr, pr = "undefined" != typeof self ? "self" : "global",
